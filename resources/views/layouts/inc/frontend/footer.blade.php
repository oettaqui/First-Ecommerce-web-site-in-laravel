...
<div class="footer-area">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <h4 class="footer-heading">Your Market</h4>
            ...
            <div class="col-md-3">
                ...
                <div class="mb-2">
                    <p>
                        <i class="fa fa-map-marker"></i>  Hay Rachad Ben guerir 
                    </p>
                </div>
                <div class="mb-2">
                    <a href="" class="text-white">
                        <i class="fa fa-phone"></i> +212 888-XXX-XXXX
                    </a>
                </div>
                <div class="mb-2">
                    <a href="" class="text-white">
                        <i class="fa fa-envelope"></i> oussamaettaqui20@gmail.com
                    </a>
                </div>
            </div>
        </div>
...
<div class="copyright-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <p class=""> &copy; 2023 - Your market - Ecommerce. All rights reserved.</p>
            </div>
            <div class="col-md-4">
