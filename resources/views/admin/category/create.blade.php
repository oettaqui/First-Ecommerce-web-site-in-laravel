    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3>
                    Add Category <a href="{{route('categories.index')}}" class="btn btn-primary text-white btn-sm float-end">Back</a>
                </h3>
            </div>
            <div class="card-body">
                <form action="{{ route('categories.store') }} " method="Post">
                  ...
                  @enderror
                    ...
                    <div class="col-md-12 my-3">
                      ...
                      <textarea class="form-control" id="description_category" name='description_category' rows="3"></textarea>
