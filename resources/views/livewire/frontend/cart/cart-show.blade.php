        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shopping-cart">
                                ...
                                <div class="row">
                                    <div class="col-md-4 my-auto">
                                        <a href="{{url('/collections/'.$cartItem->product->category->slug.'/'.$cartItem->product->slug)}}">
                                            <label class="product-name" style="color: #DF7857 ">
                                                @if ($cartItem->product->images)   
                                                    <img src="{{asset($cartItem->product->images[0]->path)}}" style="width: 50px; height: 50px" alt="{{$cartItem->product->name_product}}">
                                                @else
                                                    <img src="" style="width: 50px; height: 50px" alt="{{$cartItem->product->name_product}}">
                                                @endif
                                                {{$cartItem->product->name_product}}
                                            </label>
                                        </a>
                                    </div>
                                    <div class="col-md-2 my-auto">
                                        <label class="price">  {{$cartItem->product->price}} DH</label>
                                    </div>
                                    ...
                                    <div class="col-md-2 my-auto">
                                        <label class="price">  {{$cartItem->product->price * $cartItem->quantity}} DH</label>
                                        @php
                        ...
                        @empty
                            <div class="alert alert-warning">No Cart Items Available</div>
                        @endforelse
            ...
            <div class="row">
                ...
                <div class="col md 4 mt-3">
                    <div class="shadow-sm bg-white p-3 my-3">
                        <h4>Total :
                            <span class="float-end">{{$totalPrice}} DH</span>
                        </h4>
                        <hr>
                        <a  style="color:#fff"href="{{'/checkout'}}" class="btn btn-warning w-100">Checkout</a>
                    </div>
                </div>
            </div>
        </div>
